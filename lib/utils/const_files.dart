...
List<WeeklyTodo> getDummyWeeklyTodos() {
  return [
    WeeklyTodo(
      day: "Monday",
      tasks: [
        TodoItem(
          ...
          description: "Relax and focus on your breath for 5 minutes.",
        ...
        TodoItem(
          ...
          description: "Play a calming playlist for 10 minutes.",
          url: "https://www.youtube.com/watch?v=xyz456",
          thumbnailUrl: "https://img.youtube.com/vi/xyz456/0.jpg",
          duration: "10 minutes",
          category: "Music",
    ...
    WeeklyTodo(
      ...
      tasks: [
        TodoItem(
          ...
          description: "Practice mindfulness with a guided meditation.",
          url: "https://www.youtube.com/watch?v=def789",
          thumbnailUrl: "https://img.youtube.com/vi/def789/0.jpg",
          duration: "10 minutes",
          category: "Meditation",
